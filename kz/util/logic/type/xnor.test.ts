...
import type { Xnor } from '@kz/util/logic';
...
describe('Logic - Xnor', () => {
  ...
  describe('AsFilter', () => {
    describe('Defaults', () => {
      it('should return never', () => {
        type Actual = Xnor<true, false, AsFilter>;
        type Expected = never;
      ...
      it('should return true', () => {
        type Actual = Xnor<false, false, AsFilter>;
        type Expected = true;
    ...
    describe('custom DefaultOf', () => {
      it('should return never', () => {
        type Actual = Xnor<true, false, AsFilter & DefaultOf<string>>;
        type Expected = never;
      ...
      it('should return the DefaultOf type', () => {
        type Actual = Xnor<false, false, AsFilter & DefaultOf<string>>;
        type Expected = string;
  ...
  describe('with AsInverted', () => {
    describe('with defaults', () => {
      it('should return false', () => {
        type Actual = Xnor<true, true, AsInverted>;
        type Expected = false;
      ...
      it('should return true', () => {
        type Actual = Xnor<true, false, AsInverted>;
        type Expected = true;
      ...
      it('should return true', () => {
        type Actual = Xnor<false, true, AsInverted>;
        type Expected = true;
      ...
      it('should return false', () => {
        type Actual = Xnor<false, false, AsInverted>;
        type Expected = false;
    ...
    describe('with Then option', () => {
      it('should return false', () => {
        type Actual = Xnor<true, true, Then<string> & AsInverted>;
        type Expected = false;
    ...
    describe('with Else option', () => {
      it('should return true', () => {
        type Actual = Xnor<true, false, Else<number> & AsInverted>;
        type Expected = true;
    ...
    describe('AsFilter', () => {
      describe('Defaults', () => {
        it('should return true', () => {
          type Actual = Xnor<true, false, AsFilter & AsInverted>;
          type Expected = true;
        ...
        it('should return never', () => {
          type Actual = Xnor<false, false, AsFilter & AsInverted>;
          type Expected = never;
