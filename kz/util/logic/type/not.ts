...
/**
 * Performs a logical NOT operation on a boolean operand, returning a type that represents the result of the operation.
 *
 * # Resulting operand
...
type Result<Operand extends boolean> = ResolveBoolean<Operand, AsInverted>;
